...
# ╔═╡ bfb1e0e1-1a5b-42f8-91e4-c1de9ef0ab2c
begin
...
#define given params & lengths
begin
		# Physical parameters
	m = 0.1 #kg
	pendulum_L = 0.15 #meters
	g = 9.81 #gravitational constant

	h1 = 0.2
	w1 = 0.1
	r0 = sqrt(h1^2 + w1^2)   #offset from rotation axis (RSS of first arm)
end

# ╔═╡ bab7c5c8-ae46-438b-a0a4-cd126a749844
function rotating_pendulum(du, u, p, t) #here, u = state vector, du = state vector deriv, p = parameters, t = time. Standard to DiffEq toolbox
	theta = u[1]
	omega = u[2]
	
	k= r0 + pendulum_L*sin(theta) #horizontal distance from r0 to green circle outline showed in fig
	h= -pendulum_L*cos(theta) #vertical distance from r0 to green circle outline showed in fig
	rotation_rate = p

	du[1] = omega
	du[2] =(rotation_rate^2/pendulum_L)*(k)*cos(theta)-(g/pendulum_L)*sin(theta)
end
...
manifest_format = "2.0"
project_hash = "6074ea0cc9c840abc21666d153004976ba02274b"
...
git-tree-sha1 = "2390984f1129ceecf109b56a3cc461721d913a80"
